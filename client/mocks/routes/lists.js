// users data / chybí items as well...
const LISTS = [
  {
...
module.exports = [
  ...
  // proč je zde možnost ok - odeslat LISTS a zárověn druhý možnost - all - odeslat ALL_LISTS?
    ...
    variants: [
      {
        ...
        options: {
          status: 200, // status to send
          body: {
            id: "b2f2cce4-ee5a-4b59-839b-a39347763143",
            title: "Mock",
            status: "new",
            owner: "acec32c6-9f83-4e77-9228-9dab18e49a67",
